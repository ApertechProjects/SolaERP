...
{
    public class InvoiceMatchMainData : BaseEntity
    {
    ...
    public class InvoiceMatchDetailData : BaseEntity
    {
    ...
    public class InvoiceMatchAdvance : BaseEntity
    {
    ...
    public class InvoiceMatchGRN : BaseEntity
    {
