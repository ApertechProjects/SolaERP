...
{
    public class InvoiceRegisterDetailForPODto : InvoiceRegisterDetailForGeneralDto
    {
    ...
    public class InvoiceRegisterDetailForOtherDto : InvoiceRegisterDetailForGeneralDto
    {
    ...
    public class InvoiceRegisterDetailForGeneralDto
    {
