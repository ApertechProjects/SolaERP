	...
	public class VM_NewVendorRegistrationMailSendGLEmail : VM_EmailTemplateBase
	{
		...
		public HtmlString GetBodyOfMailAz()
		{
			return new HtmlString(
				...
				"<table width='100%' style='border-spacing: 0; padding: 0;'>" +
				...
				"<tr><td><p><b><a href='http://sola.glcorp.ltd/vendors' style='text-decoration: none; color: #0073e6;'>Təsdiq üçün daxil olun</a></b></p></td></tr>" +
		...
		public HtmlString GetBodyOfMailEn()
		{
			return new HtmlString(
				...
				"<tr><td><p><b><a href='http://sola.glcorp.ltd/vendors' style='text-decoration: none; color: #0073e6;'>Login for approval</a></b></p></td></tr>" +
