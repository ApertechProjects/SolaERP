...
public class VM_RFQDeadLine : VM_EmailTemplateBase
{
    ...
    public VM_RFQDeadLine(string lang, string vendorName, string rfqNo, DateTime rfqDeadline,
    ...
    public HtmlString GetBodyOfMailAz()
    {
        return new HtmlString(
            ...
            $"<tr><td><p>[{_rfqNo}] №-li RFQ üçün sənədlərinizi təqdim etməyiniz üçün xatırlatmadır. Xahiş edirik, sənədlərinizi tam şəkildə tamamlayıb son tarixə qədər göndərməyinizi xaiş edirik.</p></td></tr>" +
    ...
    public HtmlString GetBodyOfMailEn()
    {
        return new HtmlString(
            ...
            $"<tr><td><p>This is a friendly reminder that the [{_rfqNo}] № RFQ is pending for your submission. Please ensure that your documents are completed and sent before the deadline.</p></td></tr>" +
