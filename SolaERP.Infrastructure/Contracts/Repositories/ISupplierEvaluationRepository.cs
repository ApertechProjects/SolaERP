...
namespace SolaERP.Application.Contracts.Repositories
{
	public interface ISupplierEvaluationRepository
	{
		...
		Task<List<VendorBusinessSector>> GetBusinessSectorAsync(int vendorId);
		...
		Task<bool> DeleteNDAAsync(int vendorId);
		...
		Task<bool> ModifyVendorBusinessCategoryActivityAsync(int vendorBusinessCategoryId, bool active);
