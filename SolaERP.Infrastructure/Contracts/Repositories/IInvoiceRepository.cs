...
namespace SolaERP.Application.Contracts.Repositories
{
	public interface IInvoiceRepository
	{
		...
		Task<List<Entities.Invoice.InvoiceRegisterLoad>> GetInvoiceRegisterMainLoad(int invoiceRegisterId);
		Task<List<Entities.Invoice.InvoiceRegisterDetails>> GetInvoiceRegisterDetailsLoad(int invoiceRegisterId);
