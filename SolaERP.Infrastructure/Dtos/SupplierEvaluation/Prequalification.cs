...
namespace SolaERP.Application.Dtos.SupplierEvaluation
{
    ...
    public class PrequalificationWithCategoryDto2
    {
        public int Id { get; set; }
        public string Name { get; set; }
        public List<VM_GET_Prequalification2> Prequalifications { get; set; }
    }
    ...
    public class VM_GET_Prequalification2
    {
        public string Title { get; set; }
        public List<PrequalificationDto2> Childs { get; set; }
    }
    ...
    public class PrequalificationDto2
    {
        public int VendorPrequalificationId { get; set; }
        public int DesignId { get; set; }
        public int LineNo { get; set; }
