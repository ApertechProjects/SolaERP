...
public DateTime? GNRL_1_DATETIME { get; set; }
    ...
    public DateTime? INTCO_RCVD_DATETIME { get; set; }
    public DateTime? INTCO_TGT_PSTG_DATETIME { get; set; }
    ...
    public string? INTCO_PSTG_OPR { get; set; }
    ...
    public short? UPDATE_COUNT { get; set; }
    public short? INTCO_TYPE { get; set; }
    public short? INTCO_PSTG_STATUS { get; set; }
}