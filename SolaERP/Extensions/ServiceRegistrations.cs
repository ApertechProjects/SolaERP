...
namespace SolaERP.Extensions
{
    ...
    public static class ServiceRegistrations
    {
        ...
        private static void UseServices(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<ICommonService<RequestWFADto>, CommonService<RequestMain, RequestWFADto>>();
        }
        private static void UseRepositories(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<ICommonRepository<RequestMain>, SqlCommonRepository<RequestMain>>();
        }
