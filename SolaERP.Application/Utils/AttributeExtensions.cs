...
namespace SolaERP.Persistence.Utils
{
    ...
    {
        public static void SetAttribute(this Attribute attribute, string className, string propertyName, Type propertyType, bool isReadonly = false, object[] attributeParams = null)
        {
