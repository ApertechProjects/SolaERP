...
namespace SolaERP.Persistence.Services
{
    public class InvoiceService : IInvoiceService
    {
        ...
        public async Task<ApiResponse<int>> Save(List<InvoiceRegisterSaveModel> model, string name)
        {
            ...
            {
                if (model[i].InvoiceTransactionTypeId == 1)
                {
        ...
        public async Task<ApiResponse<bool>> SaveAdvanceClosing(List<InvoiceClosingRequest> model, int userId)
        {
            try
            {
        ...
        public async Task<ApiResponse<bool>> RetrieveInvoiceRegister(int invoiceRegisterId, int userId)
        {
            await _invoiceRepository.RetrieveInvoiceRegister(invoiceRegisterId, userId);
            return ApiResponse<bool>.Success(true);
        }
