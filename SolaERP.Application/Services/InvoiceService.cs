...
namespace SolaERP.Persistence.Services
{
    public class InvoiceService : IInvoiceService
    {
        ...
        public async Task<ApiResponse<List<GetInvoiceRegisterDetailsDto>>> GetInvoiceRegisterDetails(int invoiceRegisterId)
        {
            var data = await _invoiceRepository.GetInvoiceRegisterDetails(invoiceRegisterId);
            var dto = _mapper.Map<List<GetInvoiceRegisterDetailsDto>>(data);
            return ApiResponse<List<GetInvoiceRegisterDetailsDto>>.Success(dto, 200);
        }
