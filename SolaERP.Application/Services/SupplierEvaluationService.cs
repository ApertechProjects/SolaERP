		  ...
		  SupplierRegisterCommand2 command)
		{
			try
			{
				...
				if (vendorUsers.Count > 0)
				{
					...
					{
						Console.WriteLine("SendMailToAdminstrationForApproveRegistrationForAutoApprove: " + DateTime.Now.ToString());
				...
				{
					Console.WriteLine("SendMailToAdminstrationForApproveRegistrationForAutoApprove Else: " + DateTime.Now.ToString());
					await _mailService.SendMailToAdminstrationForApproveRegistrationForAutoApprove(Convert.ToInt32(userIdentity), changedFields);
				}
